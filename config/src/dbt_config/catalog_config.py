...
#   timestamp: 2024-10-11T03:41:52+00:00
...
class ExternalVolume(BaseModel):
    external_location: Optional[AnyUrl] = Field(None, description='The external location')
    name: Optional[str] = Field(None, description='The name of the volume')
